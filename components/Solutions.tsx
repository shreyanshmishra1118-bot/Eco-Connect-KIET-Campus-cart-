    ...
    <section id="services" className="py-20 md:py-28 bg-slate-950">
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-slate-400 mt-4">Campus Cart integrates four powerful components into one seamless digital platform, creating an ecosystem where sustainability meets convenience.</p>
        </div>
              ...
              <div className="relative w-96 h-96 flex items-center justify-center">
                  ...
                  <div className="w-40 h-40 bg-slate-800 rounded-full flex items-center justify-center">
                    <div className="text-center">
                        <span className="font-bold text-xl text-slate-100">Campus <span className="text-emerald-400">Cart</span></span>
                    </div>
                  </div>
              </div>
          </div>
